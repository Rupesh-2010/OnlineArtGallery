...
public class Admin_Signup extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        {
            String insert=db.Query("insert into admin_signup_tbl(fullname,address,contact,email,pass)values('"+fullname+"','"+address+"','"+contact+"','"+email+"','"+password+"')", "Record Inserted");
            out.println(insert);
